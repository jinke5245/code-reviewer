...
/** Options for rendering a GitLab review Markdown template. */
export type RenderGitLabReviewTemplateOptions = {
...
export function renderGitLabReviewTemplate({
  fingerprintMarker,
  template,
  values,
}: RenderGitLabReviewTemplateOptions): string {
